...
namespace NHibernate.Caches.SysCache2.Tests
{
	...
	public class SysCacheSectionFixture
	{
		...
		public void TestGetConfig()
		{
			...
			Assert.That(section, Is.Not.Null, "SysCacheSection not found");
			...
			Assert.That(region.Priority, Is.EqualTo(System.Runtime.Caching.CacheItemPriority.Default), "Unexpected region priority");
